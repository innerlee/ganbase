...
parser.add_argument('--lrD',            type=float, default=0.00005, help='learning rate for Distance, default=0.00005')
...
if opt.workdir is None:
    opt.workdir = f'samples/wgan/exp73_{datetime.now()}'.replace(' ', '_')
