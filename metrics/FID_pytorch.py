...
def _compute_statistics_of_path(path, model, batch_size, nsamples, dims, cuda):
...
def calculate_fid_given_paths(paths, batch_size, nsamples, cuda, dims):
    ...
    m1, s1 = _compute_statistics_of_path(paths[0], model, batch_size, nsamples1,
                                         dims, cuda)
    m2, s2 = _compute_statistics_of_path(paths[1], model, batch_size, nsamples2,
                                         dims, cuda)
...
if __name__ == '__main__':
    ...
    fid_value = calculate_fid_given_paths(args.path, args.batch_size, args.nsamples, args.gpu != '', args.dims)
    print('FID: ', fid_value)
