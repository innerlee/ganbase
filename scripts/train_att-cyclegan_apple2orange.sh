...
nohup python train/att_cyclegan_model.py \
    ...
    --save_dir=./checkpoints/att-cyclegan/apple2orange256_maskT0.1 \
    --visdom_env=att-cyclegan_apple2orange256_maskT0.1 \
    --load_when_switch \
    --train_batch=1  > log_att-cyclegan_apple2orange256_maskT0.1 &