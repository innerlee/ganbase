...
def calculate_inception_score(images, model, batch_size=64, splits=10,
...
def _compute_statistics_of_path(path, nsamples, model, batch_size, splits, dims, cuda):
...
def calculate_is_given_path(path, nsamples, batch_size, splits, cuda, dims):
